...
import { getContentForNavigation } from '@/content/queries'

export default async function Header() {
  const data = await getContentForNavigation()
  const content = data.navigationCollection.items[0].linksCollection.items
