...
export default async function Hero() {
  ...
  const logoWallData = await getContentForLogoWall()
  const logoWall = logoWallData.assetCollection.items
            ...
            >
              <div>
                <a
                  ...
                  href={content.callToActionsCollection.items[0].link}
                >
                  {content.callToActionsCollection.items[0].label}
                  <span className="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">
                    -&gt;
                  </span>
                </a>
              ...
              <div>
                <a
                  ...
                  href={content.callToActionsCollection.items[1].link}
                >
                  <svg
                  ...
                  <span>{content.callToActionsCollection.items[1].label}</span>
                </a>
              </div>
            </div>
          </div>
